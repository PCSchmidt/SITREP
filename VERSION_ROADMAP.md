...
| v0.17 | **Beta Testing** | **Western Hemisphere sources added (Foreign Policy, CFR, Americas Quarterly). Global briefing enhanced (12 articles/region, 8192 tokens, comprehensive analysis). Android preview APK tested on Samsung S25+. Screenshots taken. Play Store Internal Testing setup. Beta link shared for feedback.** | **8-16h** | **-** | **🔨 IN PROGRESS** |
