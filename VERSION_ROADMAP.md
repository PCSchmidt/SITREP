...
| v0.2 | LLM Synthesis | Multi-model pipeline via Open Router (GPT-4o Mini/Claude/Llama fallback). Takes scraped articles → outputs BLUF-format briefing for one region (Europe/Africa). Prompt engineering validated. | 12h | 3h | ✅ DONE |
