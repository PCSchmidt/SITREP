...
class PDFGenerator:
    ...
    def generate_pdf(
        ...
        # Generate PDF with per-page footer
    ...
    def _draw_footer(self, canvas, doc):
        ...
        canvas.drawCentredString(
            page_width / 2, 0.45 * inch,
            "UNCLASSIFIED // AI-GENERATED — Not official intelligence. "
            "Accuracy not guaranteed. Do not use for operational decision-making."
        )
        canvas.drawCentredString(
            page_width / 2, 0.30 * inch,
